  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      <header className="mb-8">
        <h1 className="font-display text-4xl sm:text-5xl font-semibold text-stone-900 tracking-tight">Mi perfil</h1>
        <p className="mt-1 text-stone-600">Datos asociados a tu cuenta</p>
      </header>
